      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4 pb-4 border-b">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Enhanced data protection with row-level security policies
              </p>
            </div>
            <Switch checked={true} disabled />
          </div>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-md p-4">
          ...
          <p className="text-sm text-amber-700">
            Your customer data is now protected with user-level access controls. Each staff member 
            can only view, edit, and manage customer records they've created. This ensures data 
            privacy and security across your organization.
          </p>
        </div>
      </CardContent>
    </Card>
